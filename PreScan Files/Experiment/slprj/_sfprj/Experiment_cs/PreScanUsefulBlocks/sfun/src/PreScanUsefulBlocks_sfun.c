  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"PreScanUsefulBlocks")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3862346799U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3021829526U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2382976722U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2466948299U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 6:
      {
        if (strcmp(aiChksum, "C7mOufyWweGS7TqpnrCUPE") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 6:
      {
        if (strcmp(tpChksum, "pwBykOhThFlw925Hg2NaJE") == 0) {
...
mxArray* load_PreScanUsefulBlocks_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "PreScanUsefulBlocks", "Experiment_cs");
