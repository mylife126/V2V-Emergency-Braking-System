...
static void initialize_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void initialize_params_c23_Experiment_cs
  (SFc23_Experiment_csInstanceStruct *chartInstance);
static void enable_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void disable_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void c23_update_debugger_state_c23_Experiment_cs
  (SFc23_Experiment_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c23_Experiment_cs
  (SFc23_Experiment_csInstanceStruct *chartInstance);
static void set_sim_state_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_st);
static void finalize_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void sf_gateway_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void mdl_start_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void c23_chartstep_c23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void initSimStructsc23_Experiment_cs(SFc23_Experiment_csInstanceStruct
  *chartInstance);
...
static void c23_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_im, const char_T *c23_identifier, real_T
  c23_b_y_data[], int32_T c23_y_sizes[2]);
static void c23_b_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
...
static const mxArray *c23_c_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static real_T c23_c_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
...
static const mxArray *c23_d_sf_marshallOut(void *chartInstanceVoid, void
  *c23_inData);
static int32_T c23_d_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void c23_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c23_mxArrayInData, const char_T *c23_varName, void *c23_outData);
static uint8_T c23_e_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_b_is_active_c23_Experiment_cs, const char_T
  *c23_identifier);
static uint8_T c23_f_emlrt_marshallIn(SFc23_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c23_u, const emlrtMsgIdentifier *c23_parentId);
static void init_dsm_address_info(SFc23_Experiment_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc23_Experiment_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c23_is_active_c23_Experiment_cs = 0U;
}
  ...
  (SFc23_Experiment_csInstanceStruct *chartInstance)
{
  ...
  c23_hoistedGlobal = chartInstance->c23_is_active_c23_Experiment_cs;
  ...
  *chartInstance, const mxArray *c23_st)
{
  ...
  chartInstance->c23_is_active_c23_Experiment_cs = c23_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c23_u, 1)),
     "is_active_c23_Experiment_cs");
  sf_mex_destroy(&c23_u);
  c23_update_debugger_state_c23_Experiment_cs(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c23_sfEvent = CALL_EVENT;
  c23_chartstep_c23_Experiment_cs(chartInstance);
  ...
  c23_c_inData_data[], int32_T c23_inData_sizes[2])
{
  ...
  const mxArray *c23_y = NULL;
  SFc23_Experiment_csInstanceStruct *chartInstance;
  chartInstance = (SFc23_Experiment_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c23_Experiment_cs_get_eml_resolved_functions_info(void)
{
  ...
  *c23_identifier)
{
  ...
  c23_y = c23_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c23_b_is_active_c23_Experiment_cs), &c23_thisId);
  sf_mex_destroy(&c23_b_is_active_c23_Experiment_cs);
  return c23_y;
}
...
void sf_c23_Experiment_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c23_Experiment_cs_get_post_codegen_info(void);
mxArray *sf_c23_Experiment_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c23_Experiment_cs_get_post_codegen_info();
...
mxArray *sf_c23_Experiment_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c23_Experiment_cs_jit_fallback_info(void)
{
...
mxArray *sf_c23_Experiment_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c23_Experiment_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"im\",},{M[8],M[0],T\"is_active_c23_Experiment_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c23_Experiment_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc23_Experiment_csInstanceStruct *)
...
static void sf_opaque_initialize_c23_Experiment_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar);
  initialize_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c23_Experiment_cs(void *chartInstanceVar)
{
  enable_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c23_Experiment_cs(void *chartInstanceVar)
{
  disable_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c23_Experiment_cs(void *chartInstanceVar)
{
  sf_gateway_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c23_Experiment_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c23_Experiment_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c23_Experiment_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc23_Experiment_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc23_Experiment_cs((SFc23_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c23_Experiment_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c23_Experiment_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c23_Experiment_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c23_Experiment_cs(SimStruct *S)
{
  SFc23_Experiment_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc23_Experiment_csInstanceStruct *)utMalloc(sizeof
    (SFc23_Experiment_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc23_Experiment_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c23_Experiment_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c23_Experiment_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c23_Experiment_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c23_Experiment_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c23_Experiment_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c23_Experiment_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c23_Experiment_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c23_Experiment_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c23_Experiment_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c23_Experiment_cs;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c23_Experiment_cs;
...
void c23_Experiment_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c23_Experiment_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c23_Experiment_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c23_Experiment_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c23_Experiment_cs_method_dispatcher.\n"
