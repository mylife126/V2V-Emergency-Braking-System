...
static void initialize_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void initialize_params_c10_Experiment_cs
  (SFc10_Experiment_csInstanceStruct *chartInstance);
static void enable_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void disable_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void c10_update_debugger_state_c10_Experiment_cs
  (SFc10_Experiment_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c10_Experiment_cs
  (SFc10_Experiment_csInstanceStruct *chartInstance);
static void set_sim_state_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_st);
static void finalize_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void sf_gateway_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void mdl_start_c10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void initSimStructsc10_Experiment_cs(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c10_machineNumber, uint32_T
  c10_chartNumber, uint32_T c10_instanceNumber);
static const mxArray *c10_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static void c10_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_b_inpoints, const char_T *c10_identifier,
  int32_T c10_y[64]);
static void c10_b_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
...
static const mxArray *c10_b_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static real_T c10_c_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
...
static const mxArray *c10_c_sf_marshallOut(void *chartInstanceVoid, void
  *c10_inData);
static int32_T c10_d_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void c10_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData);
static uint8_T c10_e_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_b_is_active_c10_Experiment_cs, const char_T
  *c10_identifier);
static uint8_T c10_f_emlrt_marshallIn(SFc10_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c10_u, const emlrtMsgIdentifier *c10_parentId);
static void init_dsm_address_info(SFc10_Experiment_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc10_Experiment_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c10_is_active_c10_Experiment_cs = 0U;
}
  ...
  (SFc10_Experiment_csInstanceStruct *chartInstance)
{
  ...
  for (c10_i0 = 0; c10_i0 < 64; c10_i0++) {
    c10_u[c10_i0] = (*chartInstance->c10_inpoints)[c10_i0];
  }

  c10_b_y = NULL;
  sf_mex_assign(&c10_b_y, sf_mex_create("y", c10_u, 6, 0U, 1U, 0U, 2, 2, 32),
                false);
  sf_mex_setcell(c10_y, 0, c10_b_y);
  c10_hoistedGlobal = chartInstance->c10_is_active_c10_Experiment_cs;
  ...
  *chartInstance, const mxArray *c10_st)
{
  ...
  c10_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 0)),
                       "inpoints", c10_iv0);
  for (c10_i1 = 0; c10_i1 < 64; c10_i1++) {
    (*chartInstance->c10_inpoints)[c10_i1] = c10_iv0[c10_i1];
  }

  chartInstance->c10_is_active_c10_Experiment_cs = c10_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c10_u, 1)),
     "is_active_c10_Experiment_cs");
  sf_mex_destroy(&c10_u);
  c10_update_debugger_state_c10_Experiment_cs(chartInstance);
  ...
  *chartInstance)
{
  ...
  c10_b_inpoints[0] = c10_b_pts[1];
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, 6);
  c10_b_inpoints[1] = c10_b_pts[0];
  CV_EML_FOR(0, 1, 0, 0);
  _SFD_EML_CALL(0U, chartInstance->c10_sfEvent, -6);
  _SFD_SYMBOL_SCOPE_POP();
  for (c10_i4 = 0; c10_i4 < 64; c10_i4++) {
    (*chartInstance->c10_inpoints)[c10_i4] = c10_b_inpoints[c10_i4];
  }
  ...
  for (c10_i5 = 0; c10_i5 < 64; c10_i5++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c10_inpoints)[c10_i5], 0U);
  }

  for (c10_i6 = 0; c10_i6 < 64; c10_i6++) {
    _SFD_DATA_RANGE_CHECK((real_T)(*chartInstance->c10_pts)[c10_i6], 1U);
  }
}
  ...
  *c10_inData)
{
  ...
  const mxArray *c10_y = NULL;
  SFc10_Experiment_csInstanceStruct *chartInstance;
  chartInstance = (SFc10_Experiment_csInstanceStruct *)chartInstanceVoid;
  c10_mxArrayOutData = NULL;
  c10_i7 = 0;
  for (c10_i8 = 0; c10_i8 < 32; c10_i8++) {
    for (c10_i9 = 0; c10_i9 < 2; c10_i9++) {
      c10_b_inData[c10_i9 + c10_i7] = (*(int32_T (*)[64])c10_inData)[c10_i9 +
        c10_i7];
    }
  ...
  c10_i10 = 0;
  for (c10_i11 = 0; c10_i11 < 32; c10_i11++) {
    for (c10_i12 = 0; c10_i12 < 2; c10_i12++) {
      c10_u[c10_i12 + c10_i10] = c10_b_inData[c10_i12 + c10_i10];
    }
  ...
  c10_y = NULL;
  sf_mex_assign(&c10_y, sf_mex_create("y", c10_u, 6, 0U, 1U, 0U, 2, 2, 32),
                false);
  ...
  int32_T c10_y[64])
{
  ...
  sf_mex_import(c10_parentId, sf_mex_dup(c10_u), c10_iv1, 1, 6, 0U, 1, 0U, 2, 2,
                32);
  for (c10_i13 = 0; c10_i13 < 64; c10_i13++) {
    c10_y[c10_i13] = c10_iv1[c10_i13];
  }
  ...
  *c10_mxArrayInData, const char_T *c10_varName, void *c10_outData)
{
  ...
  sf_mex_destroy(&c10_b_inpoints);
  c10_i14 = 0;
  for (c10_i15 = 0; c10_i15 < 32; c10_i15++) {
    for (c10_i16 = 0; c10_i16 < 2; c10_i16++) {
      (*(int32_T (*)[64])c10_outData)[c10_i16 + c10_i14] = c10_y[c10_i16 +
        c10_i14];
    }
...
const mxArray *sf_c10_Experiment_cs_get_eml_resolved_functions_info(void)
{
  ...
  *c10_identifier)
{
  ...
  c10_y = c10_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c10_b_is_active_c10_Experiment_cs), &c10_thisId);
  sf_mex_destroy(&c10_b_is_active_c10_Experiment_cs);
  return c10_y;
}
...
static void init_simulink_io_address(SFc10_Experiment_csInstanceStruct
  *chartInstance)
{
  chartInstance->c10_inpoints = (int32_T (*)[64])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c10_pts = (int32_T (*)[64])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
}
...
void sf_c10_Experiment_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c10_Experiment_cs_get_post_codegen_info(void);
mxArray *sf_c10_Experiment_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c10_Experiment_cs_get_post_codegen_info();
...
mxArray *sf_c10_Experiment_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c10_Experiment_cs_jit_fallback_info(void)
{
...
mxArray *sf_c10_Experiment_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c10_Experiment_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[14],T\"inpoints\",},{M[8],M[0],T\"is_active_c10_Experiment_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c10_Experiment_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc10_Experiment_csInstanceStruct *)
...
static void sf_opaque_initialize_c10_Experiment_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar);
  initialize_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c10_Experiment_cs(void *chartInstanceVar)
{
  enable_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c10_Experiment_cs(void *chartInstanceVar)
{
  disable_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c10_Experiment_cs(void *chartInstanceVar)
{
  sf_gateway_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c10_Experiment_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c10_Experiment_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c10_Experiment_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc10_Experiment_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc10_Experiment_cs((SFc10_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c10_Experiment_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c10_Experiment_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c10_Experiment_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c10_Experiment_cs(SimStruct *S)
{
  SFc10_Experiment_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc10_Experiment_csInstanceStruct *)utMalloc(sizeof
    (SFc10_Experiment_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc10_Experiment_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c10_Experiment_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c10_Experiment_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c10_Experiment_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c10_Experiment_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c10_Experiment_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c10_Experiment_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c10_Experiment_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c10_Experiment_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c10_Experiment_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c10_Experiment_cs;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c10_Experiment_cs;
...
void c10_Experiment_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c10_Experiment_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c10_Experiment_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c10_Experiment_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c10_Experiment_cs_method_dispatcher.\n"
