...
static void initialize_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void initialize_params_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct *
  chartInstance);
static void enable_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void disable_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_Experiment_cs
  (SFc2_Experiment_csInstanceStruct *chartInstance);
static void set_sim_state_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void mdl_start_c2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void initSimStructsc2_Experiment_cs(SFc2_Experiment_csInstanceStruct
  *chartInstance);
...
static real_T c2_norm(SFc2_Experiment_csInstanceStruct *chartInstance, real_T
                      c2_x[2]);
static real_T c2_emlrt_marshallIn(SFc2_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c2_b_alpha, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static uint8_T c2_c_emlrt_marshallIn(SFc2_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Experiment_cs, const char_T
  *c2_identifier);
static uint8_T c2_d_emlrt_marshallIn(SFc2_Experiment_csInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Experiment_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Experiment_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Experiment_cs = 0U;
}
  ...
  (SFc2_Experiment_csInstanceStruct *chartInstance)
{
  ...
  c2_u = *chartInstance->c2_alpha;
  c2_b_y = NULL;
  sf_mex_assign(&c2_b_y, sf_mex_create("y", &c2_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c2_y, 0, c2_b_y);
  c2_b_u = chartInstance->c2_is_active_c2_Experiment_cs;
  c2_c_y = NULL;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_alpha = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c2_u, 0)), "alpha");
  chartInstance->c2_is_active_c2_Experiment_cs = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_Experiment_cs");
  sf_mex_destroy(&c2_u);
...
{
  int32_T c2_k;
  real_T c2_v_p02pref[2];
  real_T c2_y;
  real_T c2_v_p02pvp[2];
  real_T c2_VectorSign;
  _sfTime_ = sf_get_time(chartInstance->S);
  for (c2_k = 0; c2_k < 2; c2_k++) {
    c2_v_p02pref[c2_k] = (*chartInstance->c2_pvp)[c2_k] - (*chartInstance->c2_p0)
      [c2_k];
  }

  c2_y = c2_norm(chartInstance, c2_v_p02pref);
  for (c2_k = 0; c2_k < 2; c2_k++) {
    c2_v_p02pvp[c2_k] = ((*chartInstance->c2_pvp)[c2_k] - (*chartInstance->c2_p0)
                         [c2_k]) / c2_y;
    c2_v_p02pref[c2_k] = (*chartInstance->c2_pref)[c2_k] -
      (*chartInstance->c2_p0)[c2_k];
  }

  c2_y = c2_norm(chartInstance, c2_v_p02pref);
  for (c2_k = 0; c2_k < 2; c2_k++) {
    c2_v_p02pref[c2_k] = ((*chartInstance->c2_pref)[c2_k] -
                          (*chartInstance->c2_p0)[c2_k]) / c2_y;
  }

  c2_VectorSign = c2_v_p02pvp[0] * c2_v_p02pref[1] - c2_v_p02pvp[1] *
    c2_v_p02pref[0];
  c2_y = 0.0;
  for (c2_k = 0; c2_k < 2; c2_k++) {
    c2_y += c2_v_p02pvp[c2_k] * c2_v_p02pref[c2_k];
  }

  *chartInstance->c2_alpha = muDoubleScalarAtan2(muDoubleScalarAbs(c2_VectorSign),
    c2_y) * muDoubleScalarSign(c2_VectorSign);
}
...
const mxArray *sf_c2_Experiment_cs_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_b_emlrt_marshallOut(1497540868U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 27);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("rdivide"), "name", "name", 27);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("eml_div"), "name", "name", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 52);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("atan2"), "name", "name", 52);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("sign"), "name", "name", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c2_info, c2_emlrt_marshallOut(
                      ...
                      c2_x[2])
{
  ...
  for (c2_k = 0; c2_k < 2; c2_k++) {
    c2_absxk = muDoubleScalarAbs(c2_x[c2_k]);
  ...
  *chartInstance, const mxArray *c2_b_alpha, const char_T *c2_identifier)
{
  ...
  c2_y = c2_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_alpha), &c2_thisId);
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Experiment_cs), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Experiment_cs);
  return c2_y;
}
...
static void init_simulink_io_address(SFc2_Experiment_csInstanceStruct
  *chartInstance)
{
  chartInstance->c2_pvp = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c2_alpha = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_pref = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_p0 = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c2_Experiment_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Experiment_cs_get_post_codegen_info(void);
mxArray *sf_c2_Experiment_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Experiment_cs_get_post_codegen_info();
...
mxArray *sf_c2_Experiment_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Experiment_cs_jit_fallback_info(void)
{
...
mxArray *sf_c2_Experiment_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Experiment_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha\",},{M[8],M[0],T\"is_active_c2_Experiment_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Experiment_cs_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Experiment_cs(void *chartInstanceVar)
{
  initialize_params_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Experiment_cs(void *chartInstanceVar)
{
  enable_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_Experiment_cs(void *chartInstanceVar)
{
  disable_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_Experiment_cs(void *chartInstanceVar)
{
  sf_gateway_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Experiment_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Experiment_cs(SimStruct* S, const mxArray
  *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Experiment_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Experiment_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Experiment_cs((SFc2_Experiment_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Experiment_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Experiment_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_Experiment_cs(SimStruct *S)
{
...
static void mdlStart_c2_Experiment_cs(SimStruct *S)
{
  SFc2_Experiment_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Experiment_csInstanceStruct *)utMalloc(sizeof
    (SFc2_Experiment_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Experiment_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_Experiment_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Experiment_cs;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_Experiment_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Experiment_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Experiment_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Experiment_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Experiment_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Experiment_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Experiment_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Experiment_cs;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_Experiment_cs;
...
void c2_Experiment_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Experiment_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Experiment_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Experiment_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Experiment_cs_method_dispatcher.\n"
