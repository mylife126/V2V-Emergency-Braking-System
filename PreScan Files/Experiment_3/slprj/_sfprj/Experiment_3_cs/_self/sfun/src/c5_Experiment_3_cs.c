...
static void initialize_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void initialize_params_c5_Experiment_3_cs
  (SFc5_Experiment_3_csInstanceStruct *chartInstance);
static void enable_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void disable_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_Experiment_3_cs
  (SFc5_Experiment_3_csInstanceStruct *chartInstance);
static void set_sim_state_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct *
  chartInstance, const mxArray *c5_st);
static void finalize_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void sf_gateway_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void mdl_start_c5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void initSimStructsc5_Experiment_3_cs(SFc5_Experiment_3_csInstanceStruct *
  chartInstance);
...
static real_T c5_norm(SFc5_Experiment_3_csInstanceStruct *chartInstance, real_T
                      c5_x[2]);
static real_T c5_emlrt_marshallIn(SFc5_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c5_b_alpha, const char_T *c5_identifier);
static real_T c5_b_emlrt_marshallIn(SFc5_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static uint8_T c5_c_emlrt_marshallIn(SFc5_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_Experiment_3_cs, const char_T
  *c5_identifier);
static uint8_T c5_d_emlrt_marshallIn(SFc5_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc5_Experiment_3_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_Experiment_3_cs = 0U;
}
  ...
  (SFc5_Experiment_3_csInstanceStruct *chartInstance)
{
  ...
  c5_u = *chartInstance->c5_alpha;
  c5_b_y = NULL;
  sf_mex_assign(&c5_b_y, sf_mex_create("y", &c5_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c5_y, 0, c5_b_y);
  c5_b_u = chartInstance->c5_is_active_c5_Experiment_3_cs;
  c5_c_y = NULL;
  ...
  chartInstance, const mxArray *c5_st)
{
  ...
  *chartInstance->c5_alpha = c5_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c5_u, 0)), "alpha");
  chartInstance->c5_is_active_c5_Experiment_3_cs = c5_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c5_u, 1)),
     "is_active_c5_Experiment_3_cs");
  sf_mex_destroy(&c5_u);
...
{
  int32_T c5_k;
  real_T c5_v_p02pref[2];
  real_T c5_y;
  real_T c5_v_p02pvp[2];
  real_T c5_VectorSign;
  _sfTime_ = sf_get_time(chartInstance->S);
  for (c5_k = 0; c5_k < 2; c5_k++) {
    c5_v_p02pref[c5_k] = (*chartInstance->c5_pvp)[c5_k] - (*chartInstance->c5_p0)
      [c5_k];
  }

  c5_y = c5_norm(chartInstance, c5_v_p02pref);
  for (c5_k = 0; c5_k < 2; c5_k++) {
    c5_v_p02pvp[c5_k] = ((*chartInstance->c5_pvp)[c5_k] - (*chartInstance->c5_p0)
                         [c5_k]) / c5_y;
    c5_v_p02pref[c5_k] = (*chartInstance->c5_pref)[c5_k] -
      (*chartInstance->c5_p0)[c5_k];
  }

  c5_y = c5_norm(chartInstance, c5_v_p02pref);
  for (c5_k = 0; c5_k < 2; c5_k++) {
    c5_v_p02pref[c5_k] = ((*chartInstance->c5_pref)[c5_k] -
                          (*chartInstance->c5_p0)[c5_k]) / c5_y;
  }

  c5_VectorSign = c5_v_p02pvp[0] * c5_v_p02pref[1] - c5_v_p02pvp[1] *
    c5_v_p02pref[0];
  c5_y = 0.0;
  for (c5_k = 0; c5_k < 2; c5_k++) {
    c5_y += c5_v_p02pvp[c5_k] * c5_v_p02pref[c5_k];
  }

  *chartInstance->c5_alpha = muDoubleScalarAtan2(muDoubleScalarAbs(c5_VectorSign),
    c5_y) * muDoubleScalarSign(c5_VectorSign);
}
...
const mxArray *sf_c5_Experiment_3_cs_get_eml_resolved_functions_info(void)
{
  const mxArray *c5_nameCaptureInfo = NULL;
  c5_nameCaptureInfo = NULL;
  sf_mex_assign(&c5_nameCaptureInfo, sf_mex_createstruct("structure", 2, 60, 1),
                false);
...
static void c5_info_helper(const mxArray **c5_info)
{
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1497540868U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("rdivide"), "name", "name", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 30);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("eml_div"), "name", "name", 30);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 30);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/matfun/norm.m"), "context",
                  "context", 32);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("abs"), "name", "name", 32);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 32);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "resolved",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 52);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("atan2"), "name", "name", 52);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1286840320U), "fileTimeLo",
                  "fileTimeLo", 56);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 56);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
    "[E]C:/Program Files/PreScan/PreScan_8.1.0/SimulationCore/MatlabCode/CompilationSheet/emlfcn_preview_angle_and_distance.p"),
                  "context", "context", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("sign"), "name", "name", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 57);
  sf_mex_addfield(*c5_info, c5_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(1356563094U), "fileTimeLo",
                  "fileTimeLo", 59);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 59);
  sf_mex_addfield(*c5_info, c5_b_emlrt_marshallOut(0U), "mFileTimeLo",
                      ...
                      c5_x[2])
{
  ...
  for (c5_k = 0; c5_k < 2; c5_k++) {
    c5_absxk = muDoubleScalarAbs(c5_x[c5_k]);
  ...
  *chartInstance, const mxArray *c5_b_alpha, const char_T *c5_identifier)
{
  ...
  c5_y = c5_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c5_b_alpha), &c5_thisId);
  sf_mex_destroy(&c5_b_alpha);
  return c5_y;
}
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_Experiment_3_cs), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_Experiment_3_cs);
  return c5_y;
}
...
static void init_simulink_io_address(SFc5_Experiment_3_csInstanceStruct
  *chartInstance)
{
  chartInstance->c5_pvp = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c5_alpha = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_pref = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c5_p0 = (real_T (*)[2])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
}
...
void sf_c5_Experiment_3_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c5_Experiment_3_cs_get_post_codegen_info(void);
mxArray *sf_c5_Experiment_3_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c5_Experiment_3_cs_get_post_codegen_info();
...
mxArray *sf_c5_Experiment_3_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c5_Experiment_3_cs_jit_fallback_info(void)
{
...
mxArray *sf_c5_Experiment_3_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_Experiment_3_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha\",},{M[8],M[0],T\"is_active_c5_Experiment_3_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_Experiment_3_cs_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c5_Experiment_3_cs(void *chartInstanceVar)
{
  initialize_params_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
  initialize_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c5_Experiment_3_cs(void *chartInstanceVar)
{
  enable_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c5_Experiment_3_cs(void *chartInstanceVar)
{
  disable_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c5_Experiment_3_cs(void *chartInstanceVar)
{
  sf_gateway_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c5_Experiment_3_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c5_Experiment_3_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c5_Experiment_3_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_Experiment_3_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc5_Experiment_3_cs((SFc5_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_Experiment_3_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_Experiment_3_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c5_Experiment_3_cs(SimStruct *S)
{
...
static void mdlStart_c5_Experiment_3_cs(SimStruct *S)
{
  SFc5_Experiment_3_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc5_Experiment_3_csInstanceStruct *)utMalloc(sizeof
    (SFc5_Experiment_3_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_Experiment_3_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c5_Experiment_3_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_Experiment_3_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c5_Experiment_3_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_Experiment_3_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_Experiment_3_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c5_Experiment_3_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c5_Experiment_3_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_Experiment_3_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_Experiment_3_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_Experiment_3_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c5_Experiment_3_cs;
...
void c5_Experiment_3_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_Experiment_3_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_Experiment_3_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_Experiment_3_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_Experiment_3_cs_method_dispatcher.\n"
