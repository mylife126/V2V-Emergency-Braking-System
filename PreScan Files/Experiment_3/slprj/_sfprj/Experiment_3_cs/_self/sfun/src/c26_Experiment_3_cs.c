...
static void initialize_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void initialize_params_c26_Experiment_3_cs
  (SFc26_Experiment_3_csInstanceStruct *chartInstance);
static void enable_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void disable_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void c26_update_debugger_state_c26_Experiment_3_cs
  (SFc26_Experiment_3_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c26_Experiment_3_cs
  (SFc26_Experiment_3_csInstanceStruct *chartInstance);
static void set_sim_state_c26_Experiment_3_cs
  (SFc26_Experiment_3_csInstanceStruct *chartInstance, const mxArray *c26_st);
static void finalize_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void sf_gateway_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void mdl_start_c26_Experiment_3_cs(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void initSimStructsc26_Experiment_3_cs
  (SFc26_Experiment_3_csInstanceStruct *chartInstance);
...
static const mxArray *c26_sf_marshallOut(void *chartInstanceVoid, void
  *c26_c_inData);
static void c26_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c26_c_Imout, const char_T *c26_identifier,
  real_T c26_b_y[562500]);
static void c26_b_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
...
static const mxArray *c26_c_sf_marshallOut(void *chartInstanceVoid, void
  *c26_c_inData);
static real_T c26_c_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c26_c_u, const emlrtMsgIdentifier *c26_parentId);
...
static const mxArray *c26_d_sf_marshallOut(void *chartInstanceVoid, void
  *c26_c_inData);
static int32_T c26_d_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c26_c_u, const emlrtMsgIdentifier *c26_parentId);
static void c26_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c26_mxArrayInData, const char_T *c26_varName, void *c26_outData);
static uint8_T c26_e_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c26_b_is_active_c26_Experiment_3_cs, const
  char_T *c26_identifier);
static uint8_T c26_f_emlrt_marshallIn(SFc26_Experiment_3_csInstanceStruct
  *chartInstance, const mxArray *c26_c_u, const emlrtMsgIdentifier *c26_parentId);
static void init_dsm_address_info(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc26_Experiment_3_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c26_is_active_c26_Experiment_3_cs = 0U;
}
  ...
  (SFc26_Experiment_3_csInstanceStruct *chartInstance)
{
  ...
  c26_hoistedGlobal = chartInstance->c26_is_active_c26_Experiment_3_cs;
  ...
  (SFc26_Experiment_3_csInstanceStruct *chartInstance, const mxArray *c26_st)
{
  ...
  chartInstance->c26_is_active_c26_Experiment_3_cs = c26_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c26_c_u, 1)),
     "is_active_c26_Experiment_3_cs");
  sf_mex_destroy(&c26_c_u);
  c26_update_debugger_state_c26_Experiment_3_cs(chartInstance);
  ...
  *c26_c_inData)
{
  ...
  const mxArray *c26_b_y = NULL;
  SFc26_Experiment_3_csInstanceStruct *chartInstance;
  chartInstance = (SFc26_Experiment_3_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c26_Experiment_3_cs_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c26_identifier)
{
  ...
  c26_b_y = c26_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c26_b_is_active_c26_Experiment_3_cs), &c26_thisId);
  sf_mex_destroy(&c26_b_is_active_c26_Experiment_3_cs);
  return c26_b_y;
}
...
void sf_c26_Experiment_3_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c26_Experiment_3_cs_get_post_codegen_info(void);
mxArray *sf_c26_Experiment_3_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c26_Experiment_3_cs_get_post_codegen_info();
...
mxArray *sf_c26_Experiment_3_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c26_Experiment_3_cs_jit_fallback_info(void)
{
...
mxArray *sf_c26_Experiment_3_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c26_Experiment_3_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Imout\",},{M[8],M[0],T\"is_active_c26_Experiment_3_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c26_Experiment_3_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc26_Experiment_3_csInstanceStruct *)
...
static void sf_opaque_initialize_c26_Experiment_3_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
  initialize_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c26_Experiment_3_cs(void *chartInstanceVar)
{
  enable_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c26_Experiment_3_cs(void *chartInstanceVar)
{
  disable_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c26_Experiment_3_cs(void *chartInstanceVar)
{
  sf_gateway_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c26_Experiment_3_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c26_Experiment_3_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c26_Experiment_3_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc26_Experiment_3_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc26_Experiment_3_cs((SFc26_Experiment_3_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c26_Experiment_3_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c26_Experiment_3_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c26_Experiment_3_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c26_Experiment_3_cs(SimStruct *S)
{
  SFc26_Experiment_3_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc26_Experiment_3_csInstanceStruct *)utMalloc(sizeof
    (SFc26_Experiment_3_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc26_Experiment_3_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c26_Experiment_3_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c26_Experiment_3_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c26_Experiment_3_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c26_Experiment_3_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c26_Experiment_3_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c26_Experiment_3_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c26_Experiment_3_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c26_Experiment_3_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c26_Experiment_3_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c26_Experiment_3_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c26_Experiment_3_cs;
...
void c26_Experiment_3_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c26_Experiment_3_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c26_Experiment_3_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c26_Experiment_3_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c26_Experiment_3_cs_method_dispatcher.\n"
