...
{
  int32_T c6_i4;
  PRESCAN_COLLISIONDETECTION_MESSAGE c6_b_in[5];
  ...
  while (c6_b_i < 5) {
    ...
    c6_d0 = (real_T)c6_b_in[_SFD_EML_ARRAY_BOUNDS_CHECK("in", (int32_T)
      _SFD_INTEGER_CHECK("i", c6_i), 1, 5, 1, 0) - 1].HEADER.valid;
  ...
  *c6_inData)
{
  ...
  int32_T c6_i19;
  PRESCAN_COLLISIONDETECTION_MESSAGE c6_b_inData[5];
  int32_T c6_i20;
  PRESCAN_COLLISIONDETECTION_MESSAGE c6_u[5];
  const mxArray *c6_y = NULL;
  ...
  for (c6_i19 = 0; c6_i19 < 5; c6_i19++) {
    c6_b_inData[c6_i19] = (*(PRESCAN_COLLISIONDETECTION_MESSAGE (*)[5])c6_inData)
      [c6_i19];
  }

  for (c6_i20 = 0; c6_i20 < 5; c6_i20++) {
...
static const mxArray *c6_in_bus_io(void *chartInstanceVoid, void *c6_pData)
{
  ...
  int32_T c6_i23;
  PRESCAN_COLLISIONDETECTION_MESSAGE c6_tmp[5];
  SFc6_PreScanUsefulBlocksInstanceStruct *chartInstance;
  chartInstance = (SFc6_PreScanUsefulBlocksInstanceStruct *)chartInstanceVoid;
  c6_mxVal = NULL;
  for (c6_i23 = 0; c6_i23 < 5; c6_i23++) {
    c6_tmp[c6_i23].HEADER.valid = *(boolean_T *)&((char_T *)(PRESCAN_HEADER *)
      &((char_T *)(PRESCAN_COLLISIONDETECTION_MESSAGE *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_MESSAGE (*)[5])c6_pData)[16 * c6_i23])[0])[0];
    c6_tmp[c6_i23].DATA.ObjectID1 = *(uint32_T *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_DATA *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_MESSAGE *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_MESSAGE (*)[5])c6_pData)[16 * c6_i23])[8])[0];
    c6_tmp[c6_i23].DATA.ObjectID2 = *(uint32_T *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_DATA *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_MESSAGE *)&((char_T *)
      (PRESCAN_COLLISIONDETECTION_MESSAGE (*)[5])c6_pData)[16 * c6_i23])[8])[4];
  }
...
static void init_simulink_io_address(SFc6_PreScanUsefulBlocksInstanceStruct
  *chartInstance)
{
  chartInstance->c6_in = (PRESCAN_COLLISIONDETECTION_MESSAGE (*)[5])
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2173925915U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(864772029U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4227836368U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(438472015U);
}
...
mxArray *sf_c6_PreScanUsefulBlocks_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("N4nZhhgyprCrUOY4RNylKC");
...
static void mdlSetWorkWidths_c6_PreScanUsefulBlocks(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(115140199U));
  ssSetChecksum1(S,(1485168068U));
  ssSetChecksum2(S,(3104300812U));
  ssSetChecksum3(S,(2577889040U));
