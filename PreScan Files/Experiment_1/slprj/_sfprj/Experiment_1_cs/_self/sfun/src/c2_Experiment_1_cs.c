...
static void initialize_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void initialize_params_c2_Experiment_1_cs
  (SFc2_Experiment_1_csInstanceStruct *chartInstance);
static void enable_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void disable_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_Experiment_1_cs
  (SFc2_Experiment_1_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Experiment_1_cs
  (SFc2_Experiment_1_csInstanceStruct *chartInstance);
static void set_sim_state_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct *
  chartInstance, const mxArray *c2_st);
static void finalize_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void sf_gateway_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void mdl_start_c2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void initSimStructsc2_Experiment_1_cs(SFc2_Experiment_1_csInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_emlrt_marshallOut(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const c2_PRESCAN_V2X_USER_GENERIC_DATA *c2_b_u);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_y, const char_T *c2_identifier,
  c2_PRESCAN_V2X_USER_GENERIC_MESSAGE *c2_c_y);
static void c2_b_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  c2_PRESCAN_V2X_USER_GENERIC_MESSAGE *c2_b_y);
static PRESCAN_HEADER c2_c_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static boolean_T c2_d_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  c2_PRESCAN_V2X_USER_GENERIC_DATA *c2_b_y);
static int32_T c2_f_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static real_T c2_g_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_emlrt_marshallOut(SFc2_Experiment_1_csInstanceStruct *
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_h_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c2_b_y);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_i_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId,
...
static uint8_T c2_j_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Experiment_1_cs, const char_T
  *c2_identifier);
static uint8_T c2_k_emlrt_marshallIn(SFc2_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c2_b_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_Experiment_1_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Experiment_1_cs = 0U;
}
  ...
  (SFc2_Experiment_1_csInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_Experiment_1_cs;
  ...
  chartInstance, const mxArray *c2_st)
{
  ...
  *(real_T *)&((char_T *)(c2_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
  ...
  chartInstance->c2_is_active_c2_Experiment_1_cs = c2_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 1)),
     "is_active_c2_Experiment_1_cs");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_Experiment_1_cs(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_d_y = NULL;
  SFc2_Experiment_1_csInstanceStruct *chartInstance;
  chartInstance = (SFc2_Experiment_1_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_Experiment_1_cs_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(const mxArray **c2_info)
{
  ...
  sf_mex_addfield(*c2_info, c2_c_emlrt_marshallOut(
    "[E]C:/Workspace/PreScan Files/Experiment_1/V2X_GENERIC_filter.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c2_info, c2_d_emlrt_marshallOut(1523908662U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c2_identifier)
{
  ...
  c2_b_y = c2_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Experiment_1_cs), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Experiment_1_cs);
  return c2_b_y;
}
...
void sf_c2_Experiment_1_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Experiment_1_cs_get_post_codegen_info(void);
mxArray *sf_c2_Experiment_1_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_Experiment_1_cs_get_post_codegen_info();
...
mxArray *sf_c2_Experiment_1_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_Experiment_1_cs_jit_fallback_info(void)
{
...
mxArray *sf_c2_Experiment_1_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_Experiment_1_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_Experiment_1_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Experiment_1_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_Experiment_1_csInstanceStruct *)
...
static void sf_opaque_initialize_c2_Experiment_1_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
  initialize_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_Experiment_1_cs(void *chartInstanceVar)
{
  enable_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_Experiment_1_cs(void *chartInstanceVar)
{
  disable_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_Experiment_1_cs(void *chartInstanceVar)
{
  sf_gateway_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_Experiment_1_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Experiment_1_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Experiment_1_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Experiment_1_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_Experiment_1_cs((SFc2_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Experiment_1_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Experiment_1_cs(SimStruct *S)
{
  SFc2_Experiment_1_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Experiment_1_csInstanceStruct *)utMalloc(sizeof
    (SFc2_Experiment_1_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_Experiment_1_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Experiment_1_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Experiment_1_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Experiment_1_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_Experiment_1_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_Experiment_1_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Experiment_1_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Experiment_1_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Experiment_1_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_Experiment_1_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_Experiment_1_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Experiment_1_cs;
...
void c2_Experiment_1_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Experiment_1_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Experiment_1_cs_method_dispatcher.\n"
