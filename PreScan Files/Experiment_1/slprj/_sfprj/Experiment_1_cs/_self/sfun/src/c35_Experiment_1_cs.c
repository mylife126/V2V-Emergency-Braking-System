...
static void initialize_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void initialize_params_c35_Experiment_1_cs
  (SFc35_Experiment_1_csInstanceStruct *chartInstance);
static void enable_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void disable_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void c35_update_debugger_state_c35_Experiment_1_cs
  (SFc35_Experiment_1_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c35_Experiment_1_cs
  (SFc35_Experiment_1_csInstanceStruct *chartInstance);
static void set_sim_state_c35_Experiment_1_cs
  (SFc35_Experiment_1_csInstanceStruct *chartInstance, const mxArray *c35_st);
static void finalize_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void sf_gateway_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void mdl_start_c35_Experiment_1_cs(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void initSimStructsc35_Experiment_1_cs
  (SFc35_Experiment_1_csInstanceStruct *chartInstance);
...
static const mxArray *c35_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static real_T c35_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_b_dTranslationY, const char_T
  *c35_identifier);
static real_T c35_b_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
...
static const mxArray *c35_b_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_c_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[2]);
...
static const mxArray *c35_c_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static void c35_d_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId,
  real_T c35_y[4]);
...
static real_T c35_cosd(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T c35_x);
static boolean_T c35_isfinite(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T c35_x);
static real_T c35_sind(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T c35_x);
static void c35_eml_scalar_eg(SFc35_Experiment_1_csInstanceStruct *chartInstance);
static void c35_eml_xgemm(SFc35_Experiment_1_csInstanceStruct *chartInstance,
...
static const mxArray *c35_d_sf_marshallOut(void *chartInstanceVoid, void
  *c35_inData);
static int32_T c35_e_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c35_mxArrayInData, const char_T *c35_varName, void *c35_outData);
static uint8_T c35_f_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_b_is_active_c35_Experiment_1_cs, const
  char_T *c35_identifier);
static uint8_T c35_g_emlrt_marshallIn(SFc35_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c35_u, const emlrtMsgIdentifier *c35_parentId);
static void c35_b_cosd(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T *c35_x);
static void c35_b_sind(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T *c35_x);
static void c35_b_eml_xgemm(SFc35_Experiment_1_csInstanceStruct *chartInstance,
  real_T c35_A[4], real_T c35_B[2], real_T c35_C[2]);
static void init_dsm_address_info(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc35_Experiment_1_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c35_is_active_c35_Experiment_1_cs = 0U;
}
  ...
  (SFc35_Experiment_1_csInstanceStruct *chartInstance)
{
  ...
  c35_c_hoistedGlobal = chartInstance->c35_is_active_c35_Experiment_1_cs;
  ...
  (SFc35_Experiment_1_csInstanceStruct *chartInstance, const mxArray *c35_st)
{
  ...
  *chartInstance->c35_dTranslationY = c35_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c35_is_active_c35_Experiment_1_cs = c35_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c35_u, 2)),
     "is_active_c35_Experiment_1_cs");
  sf_mex_destroy(&c35_u);
  c35_update_debugger_state_c35_Experiment_1_cs(chartInstance);
  ...
  *c35_inData)
{
  ...
  const mxArray *c35_y = NULL;
  SFc35_Experiment_1_csInstanceStruct *chartInstance;
  chartInstance = (SFc35_Experiment_1_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c35_Experiment_1_cs_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c35_identifier)
{
  ...
  c35_y = c35_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c35_b_is_active_c35_Experiment_1_cs), &c35_thisId);
  sf_mex_destroy(&c35_b_is_active_c35_Experiment_1_cs);
  return c35_y;
}
...
void sf_c35_Experiment_1_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c35_Experiment_1_cs_get_post_codegen_info(void);
mxArray *sf_c35_Experiment_1_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c35_Experiment_1_cs_get_post_codegen_info();
...
mxArray *sf_c35_Experiment_1_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c35_Experiment_1_cs_jit_fallback_info(void)
{
...
mxArray *sf_c35_Experiment_1_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c35_Experiment_1_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dTranslationX\",},{M[1],M[8],T\"dTranslationY\",},{M[8],M[0],T\"is_active_c35_Experiment_1_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c35_Experiment_1_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc35_Experiment_1_csInstanceStruct *)
...
static void sf_opaque_initialize_c35_Experiment_1_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
  initialize_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c35_Experiment_1_cs(void *chartInstanceVar)
{
  enable_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c35_Experiment_1_cs(void *chartInstanceVar)
{
  disable_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c35_Experiment_1_cs(void *chartInstanceVar)
{
  sf_gateway_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c35_Experiment_1_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c35_Experiment_1_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c35_Experiment_1_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc35_Experiment_1_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc35_Experiment_1_cs((SFc35_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c35_Experiment_1_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c35_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c35_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c35_Experiment_1_cs(SimStruct *S)
{
  SFc35_Experiment_1_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc35_Experiment_1_csInstanceStruct *)utMalloc(sizeof
    (SFc35_Experiment_1_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc35_Experiment_1_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c35_Experiment_1_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c35_Experiment_1_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c35_Experiment_1_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c35_Experiment_1_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c35_Experiment_1_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c35_Experiment_1_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c35_Experiment_1_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c35_Experiment_1_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c35_Experiment_1_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c35_Experiment_1_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c35_Experiment_1_cs;
...
void c35_Experiment_1_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c35_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c35_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c35_Experiment_1_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c35_Experiment_1_cs_method_dispatcher.\n"
