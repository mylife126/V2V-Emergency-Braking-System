...
static void initialize_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void initialize_params_c20_Experiment_1_cs
  (SFc20_Experiment_1_csInstanceStruct *chartInstance);
static void enable_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void disable_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void c20_update_debugger_state_c20_Experiment_1_cs
  (SFc20_Experiment_1_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_Experiment_1_cs
  (SFc20_Experiment_1_csInstanceStruct *chartInstance);
static void set_sim_state_c20_Experiment_1_cs
  (SFc20_Experiment_1_csInstanceStruct *chartInstance, const mxArray *c20_st);
static void finalize_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void sf_gateway_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void mdl_start_c20_Experiment_1_cs(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void initSimStructsc20_Experiment_1_cs
  (SFc20_Experiment_1_csInstanceStruct *chartInstance);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c20_b_color, const char_T *c20_identifier,
  real_T c20_y[100]);
static void c20_b_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_c_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
...
static const mxArray *c20_e_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_d_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static uint8_T c20_e_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c20_b_is_active_c20_Experiment_1_cs, const
  char_T *c20_identifier);
static uint8_T c20_f_emlrt_marshallIn(SFc20_Experiment_1_csInstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void init_dsm_address_info(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc20_Experiment_1_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c20_is_active_c20_Experiment_1_cs = 0U;
}
  ...
  (SFc20_Experiment_1_csInstanceStruct *chartInstance)
{
  ...
  c20_hoistedGlobal = chartInstance->c20_is_active_c20_Experiment_1_cs;
  ...
  (SFc20_Experiment_1_csInstanceStruct *chartInstance, const mxArray *c20_st)
{
  ...
  chartInstance->c20_is_active_c20_Experiment_1_cs = c20_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 2)),
     "is_active_c20_Experiment_1_cs");
  sf_mex_destroy(&c20_u);
  c20_update_debugger_state_c20_Experiment_1_cs(chartInstance);
  ...
  *c20_inData)
{
  ...
  const mxArray *c20_y = NULL;
  SFc20_Experiment_1_csInstanceStruct *chartInstance;
  chartInstance = (SFc20_Experiment_1_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c20_Experiment_1_cs_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c20_identifier)
{
  ...
  c20_y = c20_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_b_is_active_c20_Experiment_1_cs), &c20_thisId);
  sf_mex_destroy(&c20_b_is_active_c20_Experiment_1_cs);
  return c20_y;
}
...
void sf_c20_Experiment_1_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c20_Experiment_1_cs_get_post_codegen_info(void);
mxArray *sf_c20_Experiment_1_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c20_Experiment_1_cs_get_post_codegen_info();
...
mxArray *sf_c20_Experiment_1_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_Experiment_1_cs_jit_fallback_info(void)
{
...
mxArray *sf_c20_Experiment_1_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_Experiment_1_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[8],T\"color\",},{M[1],M[5],T\"r_label\",},{M[8],M[0],T\"is_active_c20_Experiment_1_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_Experiment_1_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc20_Experiment_1_csInstanceStruct *)
...
static void sf_opaque_initialize_c20_Experiment_1_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
  initialize_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c20_Experiment_1_cs(void *chartInstanceVar)
{
  enable_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c20_Experiment_1_cs(void *chartInstanceVar)
{
  disable_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c20_Experiment_1_cs(void *chartInstanceVar)
{
  sf_gateway_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c20_Experiment_1_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c20_Experiment_1_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c20_Experiment_1_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_Experiment_1_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc20_Experiment_1_cs((SFc20_Experiment_1_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_Experiment_1_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c20_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c20_Experiment_1_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_Experiment_1_cs(SimStruct *S)
{
  SFc20_Experiment_1_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc20_Experiment_1_csInstanceStruct *)utMalloc(sizeof
    (SFc20_Experiment_1_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_Experiment_1_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_Experiment_1_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c20_Experiment_1_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c20_Experiment_1_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c20_Experiment_1_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c20_Experiment_1_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_Experiment_1_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_Experiment_1_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_Experiment_1_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_Experiment_1_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_Experiment_1_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_Experiment_1_cs;
...
void c20_Experiment_1_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_Experiment_1_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_Experiment_1_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_Experiment_1_cs_method_dispatcher.\n"
