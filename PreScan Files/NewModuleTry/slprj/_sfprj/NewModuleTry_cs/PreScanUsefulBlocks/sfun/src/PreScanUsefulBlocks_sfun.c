  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"PreScanUsefulBlocks")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4251998071U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3633656054U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2408411683U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4191210006U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 6:
      {
        if (strcmp(aiChksum, "YFrGgbUNXnkmNnfgqZ1RlD") == 0) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 6:
      {
        if (strcmp(tpChksum, "Pd5lmys3Ngo73ohclsxjED") == 0) {
...
mxArray* load_PreScanUsefulBlocks_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "PreScanUsefulBlocks", "NewModuleTry_cs");
