...
static void initialize_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initialize_params_c4_NewModuleTry_cs
  (SFc4_NewModuleTry_csInstanceStruct *chartInstance);
static void enable_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void disable_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_NewModuleTry_cs
  (SFc4_NewModuleTry_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_NewModuleTry_cs
  (SFc4_NewModuleTry_csInstanceStruct *chartInstance);
static void set_sim_state_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct *
  chartInstance, const mxArray *c4_st);
static void finalize_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void sf_gateway_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void mdl_start_c4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initSimStructsc4_NewModuleTry_cs(SFc4_NewModuleTry_csInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber, uint32_T c4_instanceNumber);
static const mxArray *c4_emlrt_marshallOut(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const c4_PRESCAN_V2X_USER_GENERIC_DATA *c4_b_u);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static void c4_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_y, const char_T *c4_identifier,
  c4_PRESCAN_V2X_USER_GENERIC_MESSAGE *c4_c_y);
static void c4_b_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId,
  c4_PRESCAN_V2X_USER_GENERIC_MESSAGE *c4_b_y);
static PRESCAN_HEADER c4_c_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static boolean_T c4_d_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_e_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId,
  c4_PRESCAN_V2X_USER_GENERIC_DATA *c4_b_y);
static int32_T c4_f_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static real_T c4_g_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_emlrt_marshallOut(SFc4_NewModuleTry_csInstanceStruct *
...
static const mxArray *c4_f_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_h_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c4_b_y);
static void c4_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_i_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId,
...
static uint8_T c4_j_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_NewModuleTry_cs, const char_T
  *c4_identifier);
static uint8_T c4_k_emlrt_marshallIn(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c4_b_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc4_NewModuleTry_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_NewModuleTry_cs = 0U;
}
  ...
  (SFc4_NewModuleTry_csInstanceStruct *chartInstance)
{
  ...
  c4_hoistedGlobal = chartInstance->c4_is_active_c4_NewModuleTry_cs;
  ...
  chartInstance, const mxArray *c4_st)
{
  ...
  *(real_T *)&((char_T *)(c4_PRESCAN_V2X_USER_GENERIC_DATA *)&((char_T *)
  ...
  chartInstance->c4_is_active_c4_NewModuleTry_cs = c4_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_b_u, 1)),
     "is_active_c4_NewModuleTry_cs");
  sf_mex_destroy(&c4_b_u);
  c4_update_debugger_state_c4_NewModuleTry_cs(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_d_y = NULL;
  SFc4_NewModuleTry_csInstanceStruct *chartInstance;
  chartInstance = (SFc4_NewModuleTry_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_NewModuleTry_cs_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(const mxArray **c4_info)
{
  ...
  sf_mex_addfield(*c4_info, c4_c_emlrt_marshallOut(
    "[E]C:/Workspace/PreScan Files/NewModuleTry/V2X_GENERIC_filter.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c4_info, c4_d_emlrt_marshallOut(1520539881U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c4_identifier)
{
  ...
  c4_b_y = c4_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_NewModuleTry_cs), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_NewModuleTry_cs);
  return c4_b_y;
}
...
void sf_c4_NewModuleTry_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c4_NewModuleTry_cs_get_post_codegen_info(void);
mxArray *sf_c4_NewModuleTry_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c4_NewModuleTry_cs_get_post_codegen_info();
...
mxArray *sf_c4_NewModuleTry_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c4_NewModuleTry_cs_jit_fallback_info(void)
{
...
mxArray *sf_c4_NewModuleTry_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_NewModuleTry_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c4_NewModuleTry_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_NewModuleTry_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc4_NewModuleTry_csInstanceStruct *)
...
static void sf_opaque_initialize_c4_NewModuleTry_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
  initialize_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_NewModuleTry_cs(void *chartInstanceVar)
{
  enable_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_NewModuleTry_cs(void *chartInstanceVar)
{
  disable_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_NewModuleTry_cs(void *chartInstanceVar)
{
  sf_gateway_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c4_NewModuleTry_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c4_NewModuleTry_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c4_NewModuleTry_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_NewModuleTry_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_NewModuleTry_cs((SFc4_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_NewModuleTry_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_NewModuleTry_cs(SimStruct *S)
{
  SFc4_NewModuleTry_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc4_NewModuleTry_csInstanceStruct *)utMalloc(sizeof
    (SFc4_NewModuleTry_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_NewModuleTry_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_NewModuleTry_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_NewModuleTry_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_NewModuleTry_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_NewModuleTry_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_NewModuleTry_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_NewModuleTry_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_NewModuleTry_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_NewModuleTry_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_NewModuleTry_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_NewModuleTry_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_NewModuleTry_cs;
...
void c4_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_NewModuleTry_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_NewModuleTry_cs_method_dispatcher.\n"
