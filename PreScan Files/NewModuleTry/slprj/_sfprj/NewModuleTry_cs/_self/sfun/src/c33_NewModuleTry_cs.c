...
static void initialize_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initialize_params_c33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static void enable_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void disable_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void c33_update_debugger_state_c33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static void set_sim_state_c33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance, const mxArray *c33_st);
static void finalize_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void sf_gateway_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void mdl_start_c33_NewModuleTry_cs(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void c33_chartstep_c33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static void initSimStructsc33_NewModuleTry_cs
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance);
...
static const mxArray *c33_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static real_T c33_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_b_pedPhi, const char_T *c33_identifier);
static real_T c33_b_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
...
static const mxArray *c33_b_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static void c33_c_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId,
  real_T c33_y[4]);
...
static const mxArray *c33_c_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static void c33_d_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId,
  real_T c33_y[16]);
...
static real_T c33_cosd(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c33_x);
static boolean_T c33_isfinite(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c33_x);
static void c33_eml_scalar_eg(SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static real_T c33_sind(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c33_x);
static void c33_b_eml_scalar_eg(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void c33_threshold(SFc33_NewModuleTry_csInstanceStruct *chartInstance);
static void c33_c_eml_scalar_eg(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static real_T c33_hypot(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c33_x, real_T c33_y);
static real_T c33_atan2(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c33_y, real_T c33_x);
static const mxArray *c33_d_sf_marshallOut(void *chartInstanceVoid, void
  *c33_inData);
static int32_T c33_e_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
static void c33_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c33_mxArrayInData, const char_T *c33_varName, void *c33_outData);
static uint8_T c33_f_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_b_is_active_c33_NewModuleTry_cs, const
  char_T *c33_identifier);
static uint8_T c33_g_emlrt_marshallIn(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c33_u, const emlrtMsgIdentifier *c33_parentId);
static void c33_b_cosd(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T *c33_x);
static void c33_b_sind(SFc33_NewModuleTry_csInstanceStruct *chartInstance,
  real_T *c33_x);
static void init_dsm_address_info(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc33_NewModuleTry_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c33_is_active_c33_NewModuleTry_cs = 0U;
}
  ...
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance)
{
  ...
  c33_d_hoistedGlobal = chartInstance->c33_is_active_c33_NewModuleTry_cs;
  ...
  (SFc33_NewModuleTry_csInstanceStruct *chartInstance, const mxArray *c33_st)
{
  ...
  *chartInstance->c33_pedTheta = c33_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c33_is_active_c33_NewModuleTry_cs = c33_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c33_u, 3)),
     "is_active_c33_NewModuleTry_cs");
  sf_mex_destroy(&c33_u);
  c33_update_debugger_state_c33_NewModuleTry_cs(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c33_sfEvent = CALL_EVENT;
  c33_chartstep_c33_NewModuleTry_cs(chartInstance);
  ...
  *c33_inData)
{
  ...
  const mxArray *c33_y = NULL;
  SFc33_NewModuleTry_csInstanceStruct *chartInstance;
  chartInstance = (SFc33_NewModuleTry_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c33_NewModuleTry_cs_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c33_identifier)
{
  ...
  c33_y = c33_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c33_b_is_active_c33_NewModuleTry_cs), &c33_thisId);
  sf_mex_destroy(&c33_b_is_active_c33_NewModuleTry_cs);
  return c33_y;
}
...
void sf_c33_NewModuleTry_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c33_NewModuleTry_cs_get_post_codegen_info(void);
mxArray *sf_c33_NewModuleTry_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c33_NewModuleTry_cs_get_post_codegen_info();
...
mxArray *sf_c33_NewModuleTry_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c33_NewModuleTry_cs_jit_fallback_info(void)
{
...
mxArray *sf_c33_NewModuleTry_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c33_NewModuleTry_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[16],T\"pedPhi\",},{M[1],M[5],T\"pedR\",},{M[1],M[15],T\"pedTheta\",},{M[8],M[0],T\"is_active_c33_NewModuleTry_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c33_NewModuleTry_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc33_NewModuleTry_csInstanceStruct *)
...
static void sf_opaque_initialize_c33_NewModuleTry_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
  initialize_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c33_NewModuleTry_cs(void *chartInstanceVar)
{
  enable_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c33_NewModuleTry_cs(void *chartInstanceVar)
{
  disable_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c33_NewModuleTry_cs(void *chartInstanceVar)
{
  sf_gateway_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c33_NewModuleTry_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c33_NewModuleTry_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c33_NewModuleTry_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc33_NewModuleTry_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc33_NewModuleTry_cs((SFc33_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c33_NewModuleTry_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c33_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c33_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c33_NewModuleTry_cs(SimStruct *S)
{
  SFc33_NewModuleTry_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc33_NewModuleTry_csInstanceStruct *)utMalloc(sizeof
    (SFc33_NewModuleTry_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc33_NewModuleTry_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c33_NewModuleTry_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c33_NewModuleTry_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c33_NewModuleTry_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c33_NewModuleTry_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c33_NewModuleTry_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c33_NewModuleTry_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c33_NewModuleTry_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c33_NewModuleTry_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c33_NewModuleTry_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c33_NewModuleTry_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c33_NewModuleTry_cs;
...
void c33_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c33_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c33_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c33_NewModuleTry_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c33_NewModuleTry_cs_method_dispatcher.\n"
