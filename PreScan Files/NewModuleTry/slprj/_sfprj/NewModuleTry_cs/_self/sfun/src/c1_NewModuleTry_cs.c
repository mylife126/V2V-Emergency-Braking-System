...
static void initialize_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initialize_params_c1_NewModuleTry_cs
  (SFc1_NewModuleTry_csInstanceStruct *chartInstance);
static void enable_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void disable_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_NewModuleTry_cs
  (SFc1_NewModuleTry_csInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_NewModuleTry_cs
  (SFc1_NewModuleTry_csInstanceStruct *chartInstance);
static void set_sim_state_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct *
  chartInstance, const mxArray *c1_st);
static void finalize_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void sf_gateway_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void mdl_start_c1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initSimStructsc1_NewModuleTry_cs(SFc1_NewModuleTry_csInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_emlrt_marshallOut(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const PRESCAN_V2X_FIXED_GENERIC_DATA *c1_b_u);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_y, const char_T *c1_identifier,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c1_c_y);
static void c1_b_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId,
  PRESCAN_V2X_FIXED_GENERIC_MESSAGE *c1_b_y);
static PRESCAN_HEADER c1_c_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static boolean_T c1_d_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId,
  PRESCAN_V2X_FIXED_GENERIC_DATA *c1_b_y);
static int32_T c1_f_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static real_T c1_g_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_emlrt_marshallOut(SFc1_NewModuleTry_csInstanceStruct *
...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_h_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId,
  c1_PRESCAN_V2X_USER_GENERIC_DATA *c1_b_y);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_i_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId,
...
static uint8_T c1_j_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_NewModuleTry_cs, const char_T
  *c1_identifier);
static uint8_T c1_k_emlrt_marshallIn(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_NewModuleTry_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_NewModuleTry_cs = 0U;
}
  ...
  (SFc1_NewModuleTry_csInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_NewModuleTry_cs;
  ...
  chartInstance, const mxArray *c1_st)
{
  ...
  *(int32_T *)&((char_T *)(PRESCAN_V2X_FIXED_GENERIC_DATA *)&((char_T *)
  ...
  chartInstance->c1_is_active_c1_NewModuleTry_cs = c1_j_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_b_u, 1)),
     "is_active_c1_NewModuleTry_cs");
  sf_mex_destroy(&c1_b_u);
  c1_update_debugger_state_c1_NewModuleTry_cs(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_d_y = NULL;
  SFc1_NewModuleTry_csInstanceStruct *chartInstance;
  chartInstance = (SFc1_NewModuleTry_csInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_NewModuleTry_cs_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_c_emlrt_marshallOut(
    "[E]C:/Workspace/PreScan Files/NewModuleTry/V2X_GENERIC_expander.m"),
                  "resolved", "resolved", 0);
  sf_mex_addfield(*c1_info, c1_d_emlrt_marshallOut(1520539881U), "fileTimeLo",
                  "fileTimeLo", 0);
  ...
  *c1_identifier)
{
  ...
  c1_b_y = c1_k_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_NewModuleTry_cs), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_NewModuleTry_cs);
  return c1_b_y;
}
...
void sf_c1_NewModuleTry_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_NewModuleTry_cs_get_post_codegen_info(void);
mxArray *sf_c1_NewModuleTry_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_NewModuleTry_cs_get_post_codegen_info();
...
mxArray *sf_c1_NewModuleTry_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_NewModuleTry_cs_jit_fallback_info(void)
{
...
mxArray *sf_c1_NewModuleTry_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_NewModuleTry_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_NewModuleTry_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_NewModuleTry_cs_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_NewModuleTry_csInstanceStruct *)
...
static void sf_opaque_initialize_c1_NewModuleTry_cs(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
  initialize_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_NewModuleTry_cs(void *chartInstanceVar)
{
  enable_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_NewModuleTry_cs(void *chartInstanceVar)
{
  disable_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_NewModuleTry_cs(void *chartInstanceVar)
{
  sf_gateway_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_NewModuleTry_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_NewModuleTry_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c1_NewModuleTry_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_NewModuleTry_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_NewModuleTry_cs((SFc1_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_NewModuleTry_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_NewModuleTry_cs(SimStruct *S)
{
  SFc1_NewModuleTry_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_NewModuleTry_csInstanceStruct *)utMalloc(sizeof
    (SFc1_NewModuleTry_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_NewModuleTry_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_NewModuleTry_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_NewModuleTry_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_NewModuleTry_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_NewModuleTry_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_NewModuleTry_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_NewModuleTry_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_NewModuleTry_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_NewModuleTry_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_NewModuleTry_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_NewModuleTry_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_NewModuleTry_cs;
...
void c1_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_NewModuleTry_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_NewModuleTry_cs_method_dispatcher.\n"
