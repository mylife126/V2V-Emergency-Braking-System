#ifndef __c4_NewModuleTry_cs_h__
#define __c4_NewModuleTry_cs_h__
...
#ifndef typedef_SFc4_NewModuleTry_csInstanceStruct
#define typedef_SFc4_NewModuleTry_csInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_NewModuleTry_cs;
...
#endif                                 /*typedef_SFc4_NewModuleTry_csInstanceStruct*/
...
extern const mxArray *sf_c4_NewModuleTry_cs_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c4_NewModuleTry_cs_get_check_sum(mxArray *plhs[]);
extern void c4_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method,
  void *data);
