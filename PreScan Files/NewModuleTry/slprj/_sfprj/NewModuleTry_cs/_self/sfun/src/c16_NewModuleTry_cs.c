...
static void initialize_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initialize_params_c16_NewModuleTry_cs
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance);
static void enable_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void disable_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c16_NewModuleTry_cs
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance);
static void set_sim_state_c16_NewModuleTry_cs
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance, const mxArray *c16_st);
static void finalize_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void sf_gateway_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void mdl_start_c16_NewModuleTry_cs(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void initSimStructsc16_NewModuleTry_cs
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance);
...
static real_T c16_norm(SFc16_NewModuleTry_csInstanceStruct *chartInstance,
  real_T c16_x[2]);
static real_T c16_emlrt_marshallIn(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c16_b_alpha, const char_T *c16_identifier);
static real_T c16_b_emlrt_marshallIn(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static uint8_T c16_c_emlrt_marshallIn(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c16_b_is_active_c16_NewModuleTry_cs, const
  char_T *c16_identifier);
static uint8_T c16_d_emlrt_marshallIn(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance, const mxArray *c16_u, const emlrtMsgIdentifier *c16_parentId);
static void init_dsm_address_info(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc16_NewModuleTry_csInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c16_is_active_c16_NewModuleTry_cs = 0U;
}
  ...
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance)
{
  ...
  c16_b_u = chartInstance->c16_is_active_c16_NewModuleTry_cs;
  c16_c_y = NULL;
  ...
  (SFc16_NewModuleTry_csInstanceStruct *chartInstance, const mxArray *c16_st)
{
  ...
  *chartInstance->c16_alpha = c16_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c16_is_active_c16_NewModuleTry_cs = c16_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c16_u, 1)),
     "is_active_c16_NewModuleTry_cs");
...
const mxArray *sf_c16_NewModuleTry_cs_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c16_identifier)
{
  ...
  c16_y = c16_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c16_b_is_active_c16_NewModuleTry_cs), &c16_thisId);
  sf_mex_destroy(&c16_b_is_active_c16_NewModuleTry_cs);
  return c16_y;
}
...
void sf_c16_NewModuleTry_cs_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c16_NewModuleTry_cs_get_post_codegen_info(void);
mxArray *sf_c16_NewModuleTry_cs_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c16_NewModuleTry_cs_get_post_codegen_info();
...
mxArray *sf_c16_NewModuleTry_cs_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c16_NewModuleTry_cs_jit_fallback_info(void)
{
...
mxArray *sf_c16_NewModuleTry_cs_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c16_NewModuleTry_cs(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"alpha\",},{M[8],M[0],T\"is_active_c16_NewModuleTry_cs\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c16_NewModuleTry_cs_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c16_NewModuleTry_cs(void *chartInstanceVar)
{
  initialize_params_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
  initialize_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c16_NewModuleTry_cs(void *chartInstanceVar)
{
  enable_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c16_NewModuleTry_cs(void *chartInstanceVar)
{
  disable_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c16_NewModuleTry_cs(void *chartInstanceVar)
{
  sf_gateway_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c16_NewModuleTry_cs(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c16_NewModuleTry_cs(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c16_NewModuleTry_cs(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc16_NewModuleTry_csInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc16_NewModuleTry_cs((SFc16_NewModuleTry_csInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c16_NewModuleTry_cs(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c16_NewModuleTry_cs(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c16_NewModuleTry_cs(SimStruct *S)
{
...
static void mdlStart_c16_NewModuleTry_cs(SimStruct *S)
{
  SFc16_NewModuleTry_csInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc16_NewModuleTry_csInstanceStruct *)utMalloc(sizeof
    (SFc16_NewModuleTry_csInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc16_NewModuleTry_csInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c16_NewModuleTry_cs;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c16_NewModuleTry_cs;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c16_NewModuleTry_cs;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c16_NewModuleTry_cs;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c16_NewModuleTry_cs;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c16_NewModuleTry_cs;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c16_NewModuleTry_cs;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c16_NewModuleTry_cs;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c16_NewModuleTry_cs;
  chartInstance->chartInfo.mdlStart = mdlStart_c16_NewModuleTry_cs;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c16_NewModuleTry_cs;
...
void c16_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c16_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c16_NewModuleTry_cs(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c16_NewModuleTry_cs(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c16_NewModuleTry_cs_method_dispatcher.\n"
