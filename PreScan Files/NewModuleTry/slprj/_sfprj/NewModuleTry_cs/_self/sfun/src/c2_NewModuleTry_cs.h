#ifndef __c2_NewModuleTry_cs_h__
#define __c2_NewModuleTry_cs_h__
...
#ifndef typedef_SFc2_NewModuleTry_csInstanceStruct
#define typedef_SFc2_NewModuleTry_csInstanceStruct
...
typedef struct {
  ...
  uint8_T c2_is_active_c2_NewModuleTry_cs;
...
#endif                                 /*typedef_SFc2_NewModuleTry_csInstanceStruct*/
...
extern const mxArray *sf_c2_NewModuleTry_cs_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c2_NewModuleTry_cs_get_check_sum(mxArray *plhs[]);
extern void c2_NewModuleTry_cs_method_dispatcher(SimStruct *S, int_T method,
  void *data);
